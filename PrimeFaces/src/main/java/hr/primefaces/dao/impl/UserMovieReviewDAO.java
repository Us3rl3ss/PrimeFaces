...
@Repository
public class UserMovieReviewDAO implements IUserMovieReviewDAO {
	...
	public List<UserMovieReview> getUserMovieReviewByUserAndMovie(User user, Movie movie) {
		...
		String query = "from UserMovieReview "
	...
	public List<UserMovieReview> getUserMovieReviewByUser(User user) {
		...
		String query = "from UserMovieReview umr "
				+ "join umr.movie "
				+ "where user_id = :userId "
				+ "order by umr.created desc";
