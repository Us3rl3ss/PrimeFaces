...
@ManagedBean
@RequestScoped
public class CinemaSeatsConverter implements Converter {
	...
	public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
		...
		if (value != null && value.trim().length() > 0) {
			try {
				...
				List<CinemaSeats> list = dropDownMB.getCinemaSeatsList();
	...
	public String getAsString(FacesContext fc, UIComponent uic, Object object) {
		if (object != null) {
			return String.valueOf(((CinemaSeats) object).getId());
		} else {
			return null;
		}
	}
